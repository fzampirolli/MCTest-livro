...
\begin{table}[!ht]
  ...
  \includegraphics[width=0.9\linewidth, trim=90 255 50 40, clip]{historico-PI.pdf}
  \label{fig:failure-history-PI}
\end{table}


A Tabela~\ref{fig:failure-history-PI} apresenta as taxas médias de reprovação por quadrimestre na disciplina \textit{Lógica de Programação} (CS1) do Bacharelado em Ciência e Tecnologia. Os dados estão organizados por turno: Diurno (D) e Noturno (E).
...
Os dados agregados nas últimas linhas da Tabela~\ref{fig:failure-history-PI} revelam tendências no desempenho estudantil. Em todas as turmas oferecidas entre 2009 e 2024, a taxa média geral de reprovação foi de 36\%, com desvio padrão de 15\%, considerando 834 turmas e mais de 26.500 estudantes matriculados.
