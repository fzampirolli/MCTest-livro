...
Por exemplo, o período ideal para cursar cada disciplina, destacado com fundo rosa, apresenta uma média de aprovações superior em comparação com os períodos não ideais. Isso sugere que, quando os alunos cursam as disciplinas no momento recomendado, existem menos alunos com reprovações e o desempenho tende a ser melhor.

Outro ponto a ser destacado é a diminuição das reprovações durante a pandemia (de 2020.1 a 2022.2), o que pode ser atribuído à impossibilidade em realizar avaliações presenciais, além disso, os alunos tinham um prazo de 72 horas para concluir as provas. Esse cenário, embora tenha contribuído para uma redução nas taxas de reprovação, pode não refletir uma melhora real na aprendizagem.
...
\begin{table}[!ht]
    \centering
    \caption{Histórico de desempenhos das turmas CS0 (0005) e CS1 (0505).}
    \hspace*{1cm}
    \includegraphics[width=0.65\textheight, trim=2cm 3.5cm 2cm 8mm, clip]{historico.pdf}
