...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.99\textwidth]{cap06_figExameAtualiza1.png}
...
\begin{mybox}{corAtencao3}{\textbf{Área à esquerda da Figura \ref{fig:cap06_figExameAtualiza1} -- botão ``Criar-PDF''\\\vspace{-3mm}\hrule\vspace{1mm}}}
...
\begin{mybox}{corObs}{\textbf{Alguns exemplos de erros comuns que podem ocorrer:\\\vspace{-3mm}\hrule\vspace{3mm}}}
