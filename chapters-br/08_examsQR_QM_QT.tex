...
Se o professor enviar \textit{feedback} ao estudante, ele também receberá um arquivo chamado \verb|studentEmail_eXXX.zip|, onde \verb|XXX| é o número de identificação do exame. Esse arquivo conterá todos os PDFs enviados aos estudantes.
\end{mybox}
