...
\begin{mybox}{corCopia}{\textbf{Atenção:\\\vspace{-3mm}\hrule\vspace{3mm}}}
  Para que o método adaptativo funcione corretamente, é necessário que todas as turmas dos exames anteriores estejam selecionadas nas suas respectivas telas de configuração de exames.  \end{mybox}
