...
Uma parte crucial desse processo adaptativo é a seleção adequada das questões, classificadas com base na taxonomia de Bloom. É fundamental garantir que as questões sejam bem definidas e alinhadas aos objetivos de aprendizagem. Além disso, esse método adaptativo deve ser utilizado para motivar os estudantes a permanecerem engajados na disciplina, em vez de penalizá-los com exames excessivamente difíceis ou fáceis. É importante ressaltar que sua aplicação não deve resultar em penalizações injustas, evitando a escolha de avaliações excessivamente desafiadoras para alguns e excessivamente simples para outros.
