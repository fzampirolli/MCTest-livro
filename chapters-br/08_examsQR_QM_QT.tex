...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.3\textwidth]{cap08_figexameAdapterType.png}
...
\begin{itemize}
    ...
    \item Se o teste for do tipo \textit{Semi-Adaptive Testing by Bloom} (SATB), o parâmetro b é determinado pelo índice da taxonomia de Bloom da questão, variando entre 1 e 6;
...
\subsection*{Exemplificando o uso do método SATB}
