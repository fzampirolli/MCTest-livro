...
\contentsline {listing}{\numberline {5.8}{\ignorespaces Exemplo prático de teste de mesa paramétrico utilizando \texttt {sys.settrace} -- Parte 1: Descrição de questão.\relax }}{86}{listing.5.8}%
\contentsline {listing}{\numberline {5.9}{\ignorespaces Exemplo prático de teste de mesa paramétrico utilizando \texttt {sys.settrace} -- Parte 2: Bloco de código em Python.\relax }}{87}{listing.5.9}%
\contentsline {listing}{\numberline {5.10}{\ignorespaces Programa em Python para cálculo do fatorial.\relax }}{89}{listing.5.10}%
