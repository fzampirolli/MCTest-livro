\usepackage{booktabs} % Adicionado para carregar o pacote booktabs
\usepackage{colortbl} % Add colortbl package for \rowcolor
...
\definecolor{corEdicao2}{rgb}{0.2, 0.7, 0.9}%azul-claro
