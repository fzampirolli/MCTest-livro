...
&\textbf{Instituto Exemplo} 
              &\multirow{7}{*}[2.5mm]{\hspace{-2mm}\includegraphics[scale=1.8833333333333335]{./tmp/QRCode_672_486_123.eps}}\\ 
&\textbf{Curso Exemplo}                        & \\ 
...
\hspace{-15mm}{\tiny {\color{white}\@2468}} \hspace{0mm} 3. Criar uma matriz \( 6 \times 7 \) com elementos 
\( (i,j) = ((((i+1) * 13) + ( ( j+1) * 11)) \mod{100}) \). 
...
\\\vspace{2mm}\noindent\textbf{Questões Dissertativas}  \hfill {\color{white} \#v19}} \
...
\begin{tabular}{|l|p{10.85cm}|c}
 \cline{1-2}\multirow{7}{*}{\vspace{8mm}\includegraphics[width=2cm]{./figs/ufabc}} 
&\textbf{Instituto Exemplo} 
              &\multirow{7}{*}[2.5mm]{\hspace{-2mm}\includegraphics[scale=1.8833333333333335]{./tmp/QRCode_672_486_987.eps}}\\ 
&\textbf{Curso Exemplo}                        & \\ 
&\textbf{Disciplina:} Disciplina Exemplo \hfill                        & \\ 
&\textbf{Prof.:} Francisco Zampirolli   & \\ 
&\textbf{Turma:} Turma Exemplo
...
\hspace{-15mm}{\tiny {\color{white}\@2455}} \hspace{0mm} 2. Qual dos seguintes dispositivos é usado exclusivamente para entrada de dados em um computador?\vspace{0mm}
...
\hspace{-15mm}{\tiny {\color{white}\@2468}} \hspace{0mm} 3. Criar uma matriz \( 5 \times 5 \) com elementos 
\( (i,j) = ((((i+1) * 13) + ( ( j+1) * 11)) \mod{100}) \). 
Calcular a soma dos elementos desta matriz. Os índices \(i\) são as linhas
e \(j\) as colunas iniciadas com o valor \(0\).
...
\\\vspace{2mm}\noindent\textbf{Questões Dissertativas}  \hfill {\color{white} \#v12}} \
